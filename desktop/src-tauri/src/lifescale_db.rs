...
// ⚓ SCHEMA 单一真相源：docs/database/schema.sql
// 本文件的表结构以 docs/database/schema.sql 为准。修改任何表必须先改真相源，
// 再同步三处：backend db/migration/V1 / 本文件 / mobile lifescale_db_service.dart
